  ...
  return (
    <section className={headerStyle.seaction}>
      ...
      <div className={headerStyle.seaction_buttons}>
        <div><button className={ headerStyle.header_button  }> Перейти до веб-версії</button></div>
       <div> <button className={headerStyle.header_black_button}> Завантажити додаток на смартфон</button></div>
      </div>
    </section>
  );
};
